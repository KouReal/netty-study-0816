...
public class RpcResponse implements Serializable {
	...
	public RpcResponse(String requestid, byte responsetype, String errormsg, String content) {
		super();
		this.requestid = requestid;
		this.responsetype = responsetype;
		this.errormsg = errormsg;
	...
	public String toString() {
		return "RpcResponse [requestid=" + requestid + ", responsetype=" + responsetype + ", errormsg=" + errormsg
				+ ", content=" + content + "]";
	}
